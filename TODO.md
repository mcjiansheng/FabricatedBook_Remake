...
- [ ] 统一前端布局、输入与渲染职责。
  ...
  - [ ] 为面板、主/次按钮、禁用按钮、提示框、确认弹窗、可滚动列表、Tooltip 建立可复用组件；屏幕只组织页面结构和业务回调。
...
- [ ] 重构事件与奖励界面（参照《杀戮尖塔》的“叙事焦点 + 选项代价可读 + 结果过渡明确”结构）。
  ...
  - [ ] 事件选项应明确显示金币、生命、卡牌、藏品、概率和前置条件；不可选项显示锁定原因，而不是直接隐藏关键路线信息。（已为“巴别塔”路线显示锁定卡及“需要背叛或仇恨”；其余选项的结构化代价/概率字段待事件数据化时补齐。）
